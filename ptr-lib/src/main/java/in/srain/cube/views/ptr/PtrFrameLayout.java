...
public class PtrFrameLayout extends ViewGroup {
    ...
    private boolean allowChildEventWhenRefresh = false;
...
//                    }
                ...
                if ((moveUp && canMoveUp) || moveDown) {
                    // modify: allow child to do something when refresh
                    if(allowChildEventWhenRefresh)  dispatchTouchEventSupper(e);
                    movePos(offsetY);
                    return true;
                }
        }
    ...
    private void updatePos(int change) {
        ...
        // modify: don't cancel, allow child to do something when refresh
        if (!allowChildEventWhenRefresh
                && isUnderTouch && !mHasSendCancelEvent && mPtrIndicator.hasMovedAfterPressedDown()) {
    ...
    /**
     * allow child event when refresh
     * @param allowChildEventWhenRefresh
     */
    public void setAllowChildEventWhenRefresh(boolean allowChildEventWhenRefresh) {
        this.allowChildEventWhenRefresh = allowChildEventWhenRefresh;
    }
}
